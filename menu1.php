...
<div id="container">
  ...
  <div class="wrapper">
	...
	?>
      <div class="left">
        <h3><?php echo $dessert['Name']; ?> , P<?php echo $dessert['Price']; ?></H3>
      </div>
	...
	<a  href="#dessertphoto<?php echo $id; ?>" data-toggle="modal">
	<img src="admin/<?php echo $dessert['Photo']; ?>" class="left clear item" width="150" alt="">
	</a>
    <p class="left"><br><?php echo $dessert['Description']; ?>         

</p>
      <div class="border3"></div>
      <div class="left">
        	<?php include('desserts_photo.php'); ?>
  ...
  <footer>
    ...
    &copy; Copyright 2012 - All Rights Reserved - <a href="#">www.damailers.com</a></span><span class="right"><br />
<br />
    <br>
    <br />
    </span></span></footer>
